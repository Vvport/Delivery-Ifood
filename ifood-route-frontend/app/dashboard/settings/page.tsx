        ...
        <div className="max-w-6xl mx-auto px-10">
          {loading ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="rounded-xl border border-border/50 bg-base/40 p-4 space-y-3">
                    ...
                    <div>
                      <label className="block text-xs font-medium text-muted/70 mb-1">
                        Complemento
                        <span className="ml-1.5 text-[10px] font-normal text-muted/40 uppercase tracking-wide">
                          opcional
                        </span>
                      </label>
                      <input
              ...
              <SectionCard label="Alertas" title="Controle de atrasos" icon={<IconBell />}>
                <div className="grid grid-cols-2 gap-6 items-start">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const val = Math.max(
                          5,
                          Math.min(240, Number(e.target.value) || DEFAULT_LATE_THRESHOLD),
                        );
                  ...
                  <p className="text-xs text-muted/50 flex items-start gap-1.5 pt-7">
                    ...
                    Pedidos aguardando mais do que esse tempo são marcados como atrasados no
                    dashboard. Padrão: {DEFAULT_LATE_THRESHOLD} minutos.
                  </p>
                </div>
              </SectionCard>
              ...
              {saveError && (
                <div
                  className="flex items-center gap-2.5 rounded-xl bg-accent/10 border border-accent/30 px-4 py-3"
                  role="alert"
                >
                  <svg
