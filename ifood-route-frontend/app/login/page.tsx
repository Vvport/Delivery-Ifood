  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col" style={{ background: '#0D0F16' }}>
          ...
          >
            ...
            <div
              ...
              style={{
                width: '55%',
                background:
                  'radial-gradient(ellipse at 0% 50%, rgba(234,29,44,0.32) 0%, transparent 70%)',
              }}
            />
            ...
            <div className="absolute inset-0 pointer-events-none" aria-hidden>
              ...
              >
                ...
                <g filter="url(#glow-pin)" transform="translate(393,88)">
                  ...
                  {/* Pin teardrop */}
                  <path
                    d="M37 0C22.1 0 10 12.1 10 27C10 47.3 37 78 37 78C37 78 64 47.3 64 27C64 12.1 51.9 0 37 0Z"
                    fill={RED}
                  />
                  {/* Inner white ring */}
            ...
            <div className="relative z-10 mt-auto px-14 pb-14 au-d1">
              ...
              <p
                className="mt-5 text-base leading-relaxed max-w-[380px]"
                style={{ color: 'rgba(255,255,255,0.40)' }}
              >
                Visualize pedidos do iFood em tempo real e calcule a rota otimizada para seus
                entregadores.
              </p>
            </div>
          </div>
          ...
          >
            <div className="w-full max-w-[400px]">
              ...
              <div className="flex flex-col items-center mb-8 au">
                ...
                <h2 className="text-[28px] font-bold text-white text-center">Bem-vindo de volta</h2>
                <p
                  className="mt-2 text-[13.5px] text-center leading-relaxed max-w-[280px]"
                  style={{ color: 'rgba(255,255,255,0.40)' }}
                >
              ...
              {/* Stats row */}
              <div
                className="mt-6 pt-5 grid grid-cols-3 gap-2 au-d3"
                ...
                {[
                  {
                    ...
                    value: '1.248',
                    label: 'Pedidos monitorados hoje',
                  },
                  {
                    icon: (
                      <svg
                  ...
                  },
                  {
                    ...
                    value: 'R$ 2.350',
                    label: 'Economia estimada de rota',
                  },
        ...
        {/* ── FOOTER BAR ── */}
        <div
          className="hidden lg:flex items-center justify-between px-14 py-3.5 shrink-0"
          style={{
            background: '#0D0F16',
        ...
        >
          <p className="text-xs font-mono" style={{ color: 'rgba(255,255,255,0.22)' }}>
            &copy; {new Date().getFullYear()} <span style={{ color: RED }}>Central de Rotas.</span>{' '}
